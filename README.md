...
| 02 | slice 扩容与预分配 | `append` 的增长曲线，`make` 该给多少 cap | 待写 |
...
| | 专题 | 核心问题 | 状态 |
|---|---|---|---|
| 15 | pprof 与 trace 实战 | 从一个慢服务定位到具体那行代码 | 待写 |
| 16 | 编译器优化 | 内联预算、边界检查消除、PGO | 待写 |
...
6. **先确认实验测到的真是你以为的东西** —— 编译器会把代码删掉
7. 基准数字 / 编译器证据 / 源码机制，三条链必须吻合
8. 环境、原始数据、复现命令全部公开
9. 如实记录被推翻的假说和翻车过程
10. 结论标注版本、架构、失效条件
